...
import TournamentInformation from 'components/widgets/tournament-information';
import TournamentMatchesTimeline from 'components/widgets/tournament-matches-timeline';
import TournamentSummoners from 'components/widgets/tournament-summoners';
import TournamentModerators from 'components/widgets/tournament-moderators';
import TournamentViewers from 'components/widgets/tournament-viewers';
import TournamentApplicants from 'components/widgets/tournament-applicants';
import TournamentRating from 'components/widgets/tournament-rating';
import TournamentInvite from 'components/widgets/tournament-invite';
...
class Tournament extends Component {
  ...
  addSummoners = action => this.props.toggleModal({
    id: 'add-summoners-modal',

    options: {
      tournamentId: this.props.match.params.id,
      selectedPlayers: this.props.tournament.summoners,
      action,
    },
  });
